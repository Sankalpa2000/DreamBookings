...
#set feilds name 
      ...
      $phone = $_POST["phone"];
      $email = $_POST["email"];
$sql = "INSERT INTO customer(user_id,username,email,password,confirm_password,phone) VALUES ('','$username','$email','$password','$confirm_password','$phone')";
#check connection 
...
<!--Body-->
   <br><br><br><br><br><br>
   <center><h1 style="color: aliceblue;">Customer Register</h1></center>
   <br><br>
   <form method="post" action="<?php echo htmlspecialchars ($_SERVER["PHP_SELF"]); ?>">  
    <div class="form-box"> 
      ...
      <button class="signbtn"  onclick="window.location.href='Login.php'" >Login</button> 
