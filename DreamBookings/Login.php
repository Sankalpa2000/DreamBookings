...
#set feilds name 
      ...
      $sql = "SELECT * FROM customer WHERE username LIKE '%$username%' AND password LIKE '%$password%'";
#check connection 
...
<!--Form-->
   <br><br><br><br><br><br>
   <center><h1 style="color: aliceblue;">Customer Login</h1></center>
   <br>
   <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">  
    <div class="form-box">   
        ...
        <br>
        <button type="button" onclick="window.location.href='AdminLogin.php'">Administrator Login </button> 
        <br>
