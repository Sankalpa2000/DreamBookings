...
<!--Hotels-->
<center>
<h1 style="color: black ;padding:10px; background-color:white; font-size:50px;">Hotels</h1>
</center>
 <br>
    <?php
    $i = 0;
                         ...
                         echo "<div class='content_column'>";
                                echo "<div class='postContent'>";
                                  echo "<br><br><br>";
                                    ...
                                    echo '<br>';
                                    echo '<center>';
                                    echo "<h1>&nbsp;&nbsp;".$row['hotel_name']."</font></h1>";
                                    echo '</center>';
                                    echo '<br>';
                                    echo '<center>';
                                    ...
                                    echo " &nbsp; &nbsp; &nbsp;";
                                    echo '<center>';
                                echo" <button><font style='font-size:20px;'><a href='HotelSample.php?hotel_id={$row['hotel_id']}'> Read more </a></font></button>";
                                echo '</center>';
                         echo "</div>";
                    echo "</div>";
                echo"</div>";
