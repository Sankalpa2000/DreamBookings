    ...
    if(isset($_GET['hotel_id']))
    {
        ...
        if($result -> num_rows > 0)
        {
            ...
            { 
                ...
                echo "<br>"; 
                echo "<h2 style='color:black; padding:10px; background-color:white;'>Contact Now :&nbsp;&nbsp;".$row['hotel_contact']."</h2>";
                echo "<br>";
                echo "<h2 style='color:black; padding:10px; background-color:white;'>Address :&nbsp;&nbsp;".$row['hotel_address']."</h2>";
                echo "</div>";     
